...
/*  TODO          this.storeHost =
    ...
    public boolean putOpMessage(MessageExt messageExt, String opType) {
        ...
        if (TransactionalMessageUtil.REMOVE_TAG.equals(opType)) {
    ...
    private boolean addRemoveTagInTransactionOp(MessageExt messageExt, MessageQueue messageQueue) {
        Message message = new Message(TransactionalMessageUtil.buildOpTopic(), TransactionalMessageUtil.REMOVE_TAG,
