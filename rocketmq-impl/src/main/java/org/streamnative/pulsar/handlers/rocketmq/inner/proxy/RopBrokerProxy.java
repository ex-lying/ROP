...
//                    }
    ...
    public void start() {
        ...
        try {
            ...
            /**
             * 3.0.6的pulsar去掉了对zk的强依赖，所以需要手动创建ZkClientFactory
             * 并且ServiceConfiguration中的zookeeperServer过期了，使用metadataStoreUrl
             */
            ...
            ZooKeeperClientFactory zkClientFactory = new ZookeeperBkClientFactoryImpl(orderedExecutor);

            RopZookeeperCache ropZkCache = new RopZookeeperCache(zkClientFactory,
                    (int) config.getMetadataStoreSessionTimeoutMillis(),
                    config.getMetadataStoreOperationTimeoutSeconds(), config.getMetadataStoreUrl(),
                    orderedExecutor, brokerController.getScheduledExecutorService(),
                    config.getMetadataStoreCacheExpirySeconds());
    ...
    protected class NameserverProcessorProxy extends NameserverProcessor implements ProcessorProxyRegister {
        ...
        public boolean registerProxyProcessor() {
            ...
            /**
             * 低版本的RequestCode.GET_ROUTEINTO_BY_TOPIC=105
             */
            //RopBrokerProxy.this.registerProcessor(RequestCode.GET_ROUTEINTO_BY_TOPIC, this, processorExecutor);
            RopBrokerProxy.this.registerProcessor(105, this, processorExecutor);
    ...
    protected class SendMessageProcessorProxy extends SendMessageProcessor implements ProcessorProxyRegister {
        ...
        public boolean registerProxyProcessor() {
            ...
            RopBrokerProxy.this.registerProcessor(RequestCode.CONSUMER_SEND_MSG_BACK, this, msgCallbackProcessorExecutor);
            return true;
        }
    }
