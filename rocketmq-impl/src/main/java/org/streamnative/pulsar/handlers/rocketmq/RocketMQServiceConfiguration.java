...
import org.streamnative.pulsar.handlers.rocketmq.inner.namesvr.RopMixAll;
...
public class RocketMQServiceConfiguration extends ServiceConfiguration {
    ...
    private String rmqSysTransHalfTopic = RopMixAll.RMQ_SYS_TRANS_HALF_TOPIC;
    @FieldContext(
            category = CATEGORY_ROCKETMQ,
            doc = "The topic of RocketMQ system transfer OP half.\n"
    )
    private String rmqSysTransOpHalfTopic = RopMixAll.RMQ_SYS_TRANS_OP_HALF_TOPIC;
    @FieldContext(
            category = CATEGORY_ROCKETMQ,
            doc = "The topic of RocketMQ transfer check max time.\n"
    )
    private String rmqTransCheckMaxTimeTopic = RopMixAll.TRANS_CHECK_MAX_TIME_TOPIC;
